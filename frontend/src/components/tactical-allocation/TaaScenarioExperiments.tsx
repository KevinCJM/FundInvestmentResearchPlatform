...
export default function TaaScenarioExperiments({ preview, baselineId, experiments, onChange, onBacktest }: {
  ...
  return <div className="min-w-0 space-y-4">
    <section className={`${sectionClass} space-y-4`}><h2 className="text-lg font-semibold">如果市场不按预期走，会怎样？</h2><p className="text-sm leading-6 text-slate-500">把多个具名实验放在一起比较。完成的实验随研究版本保存；改动配置后保留假设，重新计算。</p><Feedback error={error} />
