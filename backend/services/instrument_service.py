"""Shared read-only product operations for HTTP and research tools.

Numerical implementations and existing error payloads are preserved here;
HTTP parameter parsing and route registration belong to instrument_routes.
"""
...
def instrument_analytics(
    kind: Literal["all", "etf", "fund"] = "all",
    fund_type: Optional[list[str]] = None,
    invest_type: Optional[list[str]] = None,
...
def instrument_products(
    ...
    q: str = "",
    fund_type: Optional[list[str]] = None,
    fund_category: Optional[list[str]] = None,
    invest_type: Optional[list[str]] = None,
    market: Optional[list[str]] = None,
    status: Optional[list[str]] = None,
    management: Optional[list[str]] = None,
    custodian: Optional[list[str]] = None,
    page: int = 1,
    page_size: int = 10,
    sort_by: str = "issue_amount",
    sort_dir: Literal["asc", "desc"] = "desc",
    conditions: Optional[list[str]] = None,
    snapshot_metrics: Optional[list[str]] = None,
    qdii_type: Optional[list[str]] = None,
):
