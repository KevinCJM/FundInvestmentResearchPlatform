...
const input = 'min-h-10 w-full min-w-0 rounded-lg border border-slate-300 bg-white px-2 py-2 text-sm disabled:bg-slate-100'
const button = 'min-h-10 rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm font-semibold disabled:opacity-40'
...
export default function LanguageColumnsEditor({ languages, busy, onSave, onCancel }: Props) {
  ...
  return <section aria-label={s('i18n.matrix.manageLanguages')} className="min-w-0 space-y-3 rounded-2xl border border-violet-200 bg-white p-4">
