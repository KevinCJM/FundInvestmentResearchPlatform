...
- 产品对比的收益风险象限提示使用浅色产品代码，保持深色悬浮背景上的文字对比度。
...
- `frontend/e2e/contrast.spec.ts` 另用固定产品与指标夹具触发真实图表悬停，在 320、768、1440px 下检查提示中的产品代码；初始离线错误态检查不能代替这一场景。
...
2026-09-13 使用固定离线夹具验证。

![产品象限悬浮提示](images/frontend-design-20260912/product-quadrant-tooltip.png)
